...
import { CellNetworkViewer } from "@/components/erp/viewer/cell-network-viewer";
...
export default async function CellNetworkDetailsPage({ params }: Props) {
    ...
    <div className="flex flex-col gap-6 p-4 md:p-0">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Button className="bg-orange-600 dark:bg-orange-600 hover:bg-orange-700 dark:hover:bg-orange-700 font-bold uppercase gap-2 transition-colors" asChild>
          <Link href={`/erp/redes-de-celulas/${id}/editar`}>
      ...
      <CellNetworkViewer network={data} />
    </div>
  );
}